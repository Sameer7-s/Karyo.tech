    ...
    <section className="p-6 md:p-12 py-32 bg-black border-t border-white/10 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20">
        ...
        <div className="lg:col-span-5 flex flex-col gap-12">
          ...
          >
            Clarifying Deliverable's Before They Begin with Real Process and Honest <span className="font-serif italic opacity-60">πéóπâ│πé╡πâ╝.</span>
          </motion.h2>
        </div>
          ...
          >
            ...
            >
              <span className="text-xs font-bold uppercase tracking-[0.2em] flex items-center gap-2 relative z-20 group-hover:text-black transition-colors duration-500">
                Contact <span className="text-xl">Γåù</span>
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
          ...
          >
            <p className="text-xs md:text-sm leading-relaxed mb-10 max-w-xs opacity-60 font-medium">
              Join our studio newsletter for thoughts on design, brand systems, and creative direction ΓÇö sent occasionally, when there's something worth saying.
            </p>
          ...
          <div className="md:col-span-3 md:col-start-7 lg:col-span-2 lg:col-start-7">
            ...
            >
              {['LinkedIn', 'X (Twitter)', 'Instagram'].map((social) => (
                ...
                >
                  {social} <span className="opacity-0 -translate-x-4 transition-all duration-300 text-sm">Γåù</span>
                </motion.a>
              ))}
            </motion.div>
          </div>
            ...
            >
              {['Privacy Policy', 'Terms of Service', '404'].map((legal) => (
                <motion.a
                  ...
                  className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter opacity-80 hover:opacity-100 transition-colors flex items-center gap-4"
                >
                  {legal} <span className="opacity-0 -translate-x-4 transition-all duration-300 text-sm">Γåù</span>
                </motion.a>
              ))}
            </motion.div>
          </div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-white selection:text-black">
      ...
      {/* Noise Texture Overlay ΓÇö GPU accelerated */}
      ...
      {/* Dynamic Background Gradient ΓÇö GPU composited */}
      <motion.div
      ...
      <header className="grid grid-cols-1 md:grid-cols-3 p-6 border-b border-white/10 text-[11px] uppercase tracking-widest font-medium">
        ...
        <div className="hidden md:block">
          ...
          <p>Home, Gallery, Work, Contact</p>
        </div>
        <div className="text-right hidden md:block">
          <p className="text-white/50 mb-1">Based in Tokyo µ¥▒Σ║¼</p>
      ...
      >
          ...
          >
            <div className="relative w-full">
              ...
              >
                ...
                <span className="text-[4vw] md:text-[5vw] font-medium ml-2">Γäó</span>
              </motion.h2>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 p-6 md:p-12 py-24 border-t border-white/10">
          ...
          <div className="flex flex-col justify-center items-start">
            ...
            >
              13+ yearsΓäó of digital form, sharp interactions, and relentless creative discipline and effort.
            </motion.h3>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  desc: "We use motion as a design tool ΓÇö adding clarity, rhythm, and energy to digital experiences with intention."
                },
                {
                  id: "04",
                  title: "Framer Sites",
                  desc: "Design meets execution with real-time, scalable websites ΓÇö all crafted natively inside Framer for speed and precision."
                },
                {
                  id: "05",
                  title: "UI/UX Design",
        ...
        <section className="bg-black py-24 border-t border-white/10 relative overflow-hidden min-h-[800px] flex flex-col">
          <div className="px-6 md:px-12 flex justify-between items-center text-[10px] uppercase tracking-[0.2em] font-bold opacity-40 mb-12">
            <span>┬⌐ BRAND PARTNERS πâæπâ╝πâêπâèπâ╝</span>
            <span>(WDX┬« ΓÇö 08)</span>
        ...
        <section className="border-y border-white/10 bg-black">
          ...
          >
            {[
              ...
              >
                {social.name} <span className="opacity-40 group-hover:opacity-100 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all">Γåù</span>
              </motion.a>
            ))}
          </motion.div>
        </section>
